...
ConfigFactory::ConfigFactory() {
	...
	std::ifstream infile(pixelsHome + "writer_cpp_test/pixels-cxx.properties");
	std::cout<<"pixels properties file is "<<pixelsHome + "writer_cpp_test/pixels-cxx.properties"<<std::endl;
	std::string line;
