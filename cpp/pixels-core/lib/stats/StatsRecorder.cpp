...
void StatsRecorder::increment()
{ numberOfValues++; }

void StatsRecorder::increment(long count)
{ numberOfValues += count; }


void StatsRecorder::setHasNull()
{ hasNull = true; }
...
long StatsRecorder::getNumberOfValues() const
{ return numberOfValues; }

bool StatsRecorder::hasNullValue() const
{ return hasNull; }
