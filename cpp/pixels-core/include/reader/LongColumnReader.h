...
#ifndef PIXELS_LONGCOLUMNREADER_H
#define PIXELS_LONGCOLUMNREADER_H

#include "reader/ColumnReader.h"
#include "encoding/RunLenIntDecoder.h"

class LongColumnReader : public ColumnReader
{
public:
  explicit LongColumnReader(std::shared_ptr <TypeDescription> type);
...
#endif // PIXELS_LONGCOLUMNREADER_H
