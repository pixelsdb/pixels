...
unique_ptr<TableRef>
PixelsScanReplacement(ClientContext &context, ReplacementScanInput &input,
  ...
  if (!StringUtil::EndsWith(lower_name, ".pxl") &&
      !StringUtil::Contains(lower_name, ".pxl?")) {
    return nullptr;
  }
  ...
  table_function->function =
      make_uniq<FunctionExpression>("pixels_scan", std::move(children));
...
std::string PixelsExtension::Name() { return "pixels"; }
