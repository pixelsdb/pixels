...
#include "../include/io_pixelsdb_pixels_cache_legacy_NativeRadixIndexReader.h"
...
Java_io_pixelsdb_pixels_cache_NativeRadixIndexReader_search(JNIEnv
*env,
jobject obj, jlong
addr,
jlong size, jobject
retBuf,
jlong blockId, jshort
rowGroupId,
jshort columnId
)
{
...
for (
int i = currentNodeChildrenNum * 8 + 1;
i < edgeEndOffset && bytesMatched < KEY_LEN; ++i)
{
