...
#include "../include/io_pixelsdb_pixels_cache_legacy_utils_RadixIndexEndianRewriter.h"
...
Java_io_pixelsdb_pixels_cache_utils_RadixIndexEndianRewriter_rewrite(JNIEnv
*env,
jobject obj
)
{
