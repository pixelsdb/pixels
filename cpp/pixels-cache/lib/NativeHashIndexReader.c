...
#include "../include/io_pixelsdb_pixels_cache_legacy_NativeHashIndexReader.h"
...
Java_io_pixelsdb_pixels_cache_NativeHashIndexReader_doNativeSearch
(JNIEnv
*env,
jobject this, jlong
mmAddr,
...
memcpy(key,
&blockId, sizeof(blockId));
memcpy(key
+ sizeof(blockId), &rowGroupId, sizeof(rowGroupId));
memcpy(key
+ sizeof(blockId) + sizeof(rowGroupId), &columnId, sizeof(columnId));
