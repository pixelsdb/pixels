        ...
        implements ConnectorTableHandle
{
    ...
    public PixelsTableHandle(
            ...
            @JsonProperty("columnHandles") List<PixelsColumnHandle> columnHandles,
    ...
    @JsonProperty
    public List<PixelsColumnHandle> getColumnHandles()
    {
    ...
    public ConnectorTableMetadata toTableMetadata()
    {
        return new ConnectorTableMetadata(
                toSchemaTableName(),
                columnHandles.stream().map(PixelsColumnHandle::toColumnMetadata).collect(toList()));
    }
