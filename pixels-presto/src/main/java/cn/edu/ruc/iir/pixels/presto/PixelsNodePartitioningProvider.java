...
public class PixelsNodePartitioningProvider
        implements ConnectorNodePartitioningProvider
{
    private final NodeManager nodeManager;

    public PixelsNodePartitioningProvider(NodeManager nodeManager)
    {
    ...
    {
        return value -> {
            throw new PrestoException(NOT_SUPPORTED, "Pixels connector does not supported distributed reads");
        };
    }
