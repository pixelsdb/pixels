...
public final class PixelsSplitManager
        implements ConnectorSplitManager
{
    ...
    {
        PixelsTableLayoutHandle layout = (PixelsTableLayoutHandle) layoutHandle;

        ImmutableList.Builder<PixelsSplit> builder = ImmutableList.builder();
