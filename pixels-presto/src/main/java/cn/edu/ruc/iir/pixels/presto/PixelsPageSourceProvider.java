...
import static com.facebook.presto.spi.type.Decimals.*;
...
public final class PixelsPageSourceProvider
        implements ConnectorPageSourceProvider
{
    private final ListeningScheduledExecutorService executorService;

    public PixelsPageSourceProvider(ListeningScheduledExecutorService executorService)
    {
            ...
            List<ColumnHandle> columns)
    {
        ...
        for (ColumnHandle column : columns) {
            builder.add(((PixelsColumnHandle) column).getColumnType());
        }
        List<Type> types = builder.build();

        Page page = generateZeroPage(types, pixelsSplit.getRowsPerPage(), pixelsSplit.getFieldsLength());
        return new PixelsPageSource(page, pixelsSplit.getPagesCount(), executorService, pixelsSplit.getPageProcessingDelay());
    }
