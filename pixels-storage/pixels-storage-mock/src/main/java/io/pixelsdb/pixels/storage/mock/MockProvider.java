 ...
 * @create 2023-04-15
 */
public class MockProvider implements StorageProvider
{
    @Override
                                       ...
                                       @Nullable PhysicalReaderOption option) throws IOException
    {
        ...
        return new PhysicalMockReader(storage, path);
    }
    ...
    {
        throw new IOException(new UnsupportedOperationException("mock storage is not writable"));
    }

    @Override
    public boolean compatibleWith(@Nonnull Storage.Scheme scheme)
    {
        return scheme.equals(Storage.Scheme.mock);
    }
}
