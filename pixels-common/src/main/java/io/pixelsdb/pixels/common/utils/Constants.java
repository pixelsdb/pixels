...
public final class Constants
{
    ...
    public static final int CHECKPOINT_BUFFER_SIZE = 8 * 1024 * 1024;
    public static final int STORAGE_GC_JOURNAL_BUFFER_SIZE = 64 * 1024;
    ...
    public static final int TRANS_WATERMARKS_CHECKPOINT_INTERVAL_SEC = 10;
    /**
