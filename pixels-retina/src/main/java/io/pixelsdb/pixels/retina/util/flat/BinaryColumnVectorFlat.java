...
public final class BinaryColumnVectorFlat extends Table {
  ...
  public io.pixelsdb.pixels.retina.util.flat.ByteArray vector(int j) { return vector(new io.pixelsdb.pixels.retina.util.flat.ByteArray(), j); }
  public io.pixelsdb.pixels.retina.util.flat.ByteArray vector(io.pixelsdb.pixels.retina.util.flat.ByteArray obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int vectorLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public io.pixelsdb.pixels.retina.util.flat.ByteArray.Vector vectorVector() { return vectorVector(new io.pixelsdb.pixels.retina.util.flat.ByteArray.Vector()); }
  public io.pixelsdb.pixels.retina.util.flat.ByteArray.Vector vectorVector(io.pixelsdb.pixels.retina.util.flat.ByteArray.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
