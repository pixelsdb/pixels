...
public class TestBroadcastChainJoinInvoker
{
    ...
    {
        String json = "{\"chainJoinInfos\":[{\"joinType\":\"EQUI_INNER\",\"keyColumnIds\":[0],\"largeColumnAlias\":[],\"largeProjection\":[false,false],\"postPartition\":false,\"smallColumnAlias\":[\"s_suppkey\"],\"smallProjection\":[true,false]}],\"joinInfo\":{\"joinType\":\"EQUI_INNER\",\"largeColumnAlias\":[\"ps_availqty\",\"ps_partkey\",\"ps_supplycost\"],\"largeProjection\":[true,false,true,true],\"postPartition\":false,\"smallColumnAlias\":[],\"smallProjection\":[false]},\"largeTable\":{\"columnsToRead\":[\"ps_partkey\",\"ps_suppkey\",\"ps_availqty\",\"ps_supplycost\"],\"filter\":\"{\\\"schemaName\\\":\\\"tpch\\\",\\\"tableName\\\":\\\"partsupp\\\",\\\"columnFilters\\\":{}}\",\"inputSplits\":[{\"inputInfos\":[{\"path\":\"pixels-tpch/partsupp/v-0-compact/20220313172837_3.compact.pxl\",\"rgLength\":4,\"rgStart\":16}]}],\"keyColumnIds\":[1],\"tableName\":\"partsupp\"},\"output\":{\"accessKey\":\"lambda\",\"encoding\":true,\"endpoint\":\"http://172.31.32.193:9000\",\"fileNames\":[\"join_28\"],\"path\":\"pixels-lambda/output/\",\"randomFileName\":false,\"scheme\":\"minio\",\"secretKey\":\"password\"},\"postChainJoinsExist\":false,\"queryId\":10,\"smallTables\":[{\"columnsToRead\":[\"s_suppkey\",\"s_nationkey\"],\"filter\":\"{\\\"schemaName\\\":\\\"tpch\\\",\\\"tableName\\\":\\\"supplier\\\",\\\"columnFilters\\\":{}}\",\"inputSplits\":[{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":0}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":4}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":8}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":12}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":16}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":20}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":24}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/supplier/v-0-compact/20220313101902_0.compact.pxl\",\"rgLength\":4,\"rgStart\":28}]}],\"keyColumnIds\":[1],\"tableName\":\"supplier\"},{\"columnsToRead\":[\"n_nationkey\",\"n_name\"],\"filter\":\"{\\\"schemaName\\\":\\\"tpch\\\",\\\"tableName\\\":\\\"nation\\\",\\\"columnFilters\\\":{1:{\\\"columnName\\\":\\\"n_name\\\",\\\"columnType\\\":\\\"CHAR\\\",\\\"filterJson\\\":\\\"{\\\\\\\"javaType\\\\\\\":\\\\\\\"java.lang.String\\\\\\\",\\\\\\\"isAll\\\\\\\":false,\\\\\\\"isNone\\\\\\\":false,\\\\\\\"allowNull\\\\\\\":false,\\\\\\\"onlyNull\\\\\\\":false,\\\\\\\"ranges\\\\\\\":[],\\\\\\\"discreteValues\\\\\\\":[{\\\\\\\"type\\\\\\\":\\\\\\\"INCLUDED\\\\\\\",\\\\\\\"value\\\\\\\":\\\\\\\"GERMANY\\\\\\\"}]}\\\"}}}\",\"inputSplits\":[{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":0}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":4}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":8}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":12}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":16}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":20}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":24}]},{\"inputInfos\":[{\"path\":\"pixels-tpch/nation/v-0-order/20220313080937_0.pxl\",\"rgLength\":4,\"rgStart\":28}]}],\"keyColumnIds\":[0],\"tableName\":\"nation\"}]}";
        BroadcastChainJoinInput joinInput = JSON.parseObject(json, BroadcastChainJoinInput.class);
        JoinOutput output = BroadcastChainJoinInvoker.invoke(joinInput).get();
        System.out.println(output.getOutputs().size());
        for (int i = 0; i < output.getOutputs().size(); ++i)
        {
