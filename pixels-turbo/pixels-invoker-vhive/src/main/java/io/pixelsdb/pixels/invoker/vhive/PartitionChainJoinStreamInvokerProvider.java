...
public class PartitionChainJoinStreamInvokerProvider implements InvokerProvider
{
    ...
    public Invoker createInvoker()
    {
        ...
        return new PartitionChainJoinStreamInvoker(partitionJoinWorker);
    }

    @Override
    public WorkerType workerType() { return WorkerType.PARTITIONED_CHAIN_JOIN_STREAMING; }
