...
public class BasePartitionedJoinWorker extends Worker<PartitionedJoinInput, JoinOutput>
{
        ...
        try
        {
            ...
            for (int i = 0; i < leftPartitioned.size(); i += leftSplitSize)
            {
                ...
                leftFutures.add(threadPool.submit(() -> {
                    try
                    {
                        buildHashTable(transId, (HashJoiner) joiner, parts, leftColumnsToRead, leftInputStorageInfo.getScheme(),
     ...
     */
    protected static void buildHashTable(long transId, HashJoiner joiner, List<String> leftParts, String[] leftCols,
