...
public class BasePartitionedChainJoinWorker extends Worker<PartitionedChainJoinInput, JoinOutput>
{
            ...
            List<ChainJoinInfo> chainJoinInfos, TypeDescription lastResultSchema, WorkerMetrics workerMetrics)
    {
        ...
        try
        {
            ...
            Joiner currJoiner = BaseBroadcastChainJoinWorker.buildFirstJoiner(queryId, executor, t1, t2, currChainJoin, workerMetrics);
            for (int i = 1; i < chainTables.size() - 1; ++i)
            {
                ...
                BaseBroadcastChainJoinWorker.chainJoin(queryId, executor, currJoiner, nextJoiner, currRightTable, workerMetrics);
            ...
            BaseBroadcastChainJoinWorker.chainJoin(queryId, executor, currJoiner, finalJoiner, lastChainTable, workerMetrics);
