 ...
 */
package io.pixelsdb.pixels.turbo.planner.plan.physical.input;

import io.pixelsdb.pixels.turbo.planner.plan.physical.domain.PartialAggregationInfo;
import io.pixelsdb.pixels.turbo.planner.plan.physical.domain.MultiOutputInfo;
import io.pixelsdb.pixels.turbo.planner.plan.physical.domain.PartitionedJoinInfo;
import io.pixelsdb.pixels.turbo.planner.plan.physical.domain.PartitionedTableInfo;
