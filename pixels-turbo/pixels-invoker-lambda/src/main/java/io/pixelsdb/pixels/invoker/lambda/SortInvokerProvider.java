...
import static io.pixelsdb.pixels.common.turbo.WorkerType.SORT;

public class SortInvokerProvider implements InvokerProvider
{
    ...
    {
        String sortWorker = config.getProperty("sort.worker.name");
        return new SortInvoker(sortWorker);
    }
