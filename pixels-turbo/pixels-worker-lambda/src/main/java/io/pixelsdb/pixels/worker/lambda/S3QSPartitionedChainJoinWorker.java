...
public class S3QSPartitionedChainJoinWorker implements RequestHandler<StageWorkerInput, JoinOutput>
{
    private static final Logger logger = LogManager.getLogger(S3QSPartitionedChainJoinWorker.class);
    ...
    public JoinOutput handleRequest(StageWorkerInput event, Context context)
    {
        ...
        return new S3QSStageWorkerRunner(workerContext).runPartitionedChainJoin(event);
    }
}
