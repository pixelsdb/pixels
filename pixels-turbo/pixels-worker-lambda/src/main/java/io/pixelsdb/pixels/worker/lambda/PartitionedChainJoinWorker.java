...
public class PartitionedChainJoinWorker implements RequestHandler<PartitionedChainJoinInput, JoinOutput>
{
            ...
            List<ChainJoinInfo> chainJoinInfos, TypeDescription lastResultSchema, MetricsCollector metricsCollector)
    {
        ...
        try
        {
            ...
            Joiner currJoiner = BroadcastChainJoinWorker.buildFirstJoiner(queryId, executor, t1, t2, currChainJoin, metricsCollector);
            for (int i = 1; i < chainTables.size() - 1; ++i)
            {
                ...
                BroadcastChainJoinWorker.chainJoin(queryId, executor, currJoiner, nextJoiner, currRightTable, metricsCollector);
            ...
            BroadcastChainJoinWorker.chainJoin(queryId, executor, currJoiner, finalJoiner, lastChainTable, metricsCollector);
