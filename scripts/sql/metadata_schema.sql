...
CREATE TABLE IF NOT EXISTS `pixels_metadata`.`PATHS` (
    ...
    `RANGES_RANGE_ID` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pixels_metadata`.`USER_HAS_DB` (
    ...
    `DBS_DB_ID` BIGINT NOT NULL,
    `USER_DB_PERMITION` CHAR NOT NULL,
