-- Run the following statements in Presto/Trino to create the Pixels database for ClickBench
...
CREATE TABLE IF NOT EXISTS hits (
  ...
  "urlhash" bigint,
  "clid" int
) WITH (storage='file', paths='file:///data/p4510-1/pixels/clickbench/hits/');
