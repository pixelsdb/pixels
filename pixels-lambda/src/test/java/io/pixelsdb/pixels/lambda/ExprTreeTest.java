...
public class ExprTreeTest {
    ...
    public void initializeOldRowBatch() {
        ...
        oldRowBatch.size = 5;
        oldRowBatch.cols[0].add(2);oldRowBatch.cols[1].add(5);oldRowBatch.cols[2].add("kobe");
        oldRowBatch.cols[0].add(3);oldRowBatch.cols[1].add(2);oldRowBatch.cols[2].add("bryant");
        oldRowBatch.cols[0].add(4);oldRowBatch.cols[1].add(2);oldRowBatch.cols[2].add("kobe");
        oldRowBatch.cols[0].add(5);oldRowBatch.cols[1].add(2);oldRowBatch.cols[2].add("bryant");
        oldRowBatch.cols[0].add(3);oldRowBatch.cols[1].add(4);oldRowBatch.cols[2].add("antisocial");
        ...
        oldRowBatch.cols[4].add(3.23);oldRowBatch.cols[5].add("P");
        oldRowBatch.cols[4].add(5.43);oldRowBatch.cols[5].add("F");
        oldRowBatch.cols[4].add(2.13);oldRowBatch.cols[5].add("P");
        oldRowBatch.cols[4].add(6.00);oldRowBatch.cols[5].add("F");
        oldRowBatch.cols[4].add(5.02);oldRowBatch.cols[5].add("O");
