...
//                    }
                    ...
                    double elapsed = (double) (searchEnd - searchStart) / 1e6;
...
//                                + " bandwidth=" + (totalBytes / 1000.0 / 1000.0) / (elapsed / 1e3) + "Mb/s" + " readCount=" + pixelsCacheIdxs.size());
        ...
        System.out.printf("threads=%d, totalIOPS=%f, bandwidth=%fMB(%fMiB), latency=%fms%n", threadNum, totalIOPS, totalBandwidthMB, totalBandwidthMiB, averageLatency);
