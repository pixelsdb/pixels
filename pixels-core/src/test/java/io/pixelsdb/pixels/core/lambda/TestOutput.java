...
public class TestOutput
{
    ...
    public void testEncodeScanOutput()
    {
        ...
        scanOutput.addOutput("pixels-test/0.out");
        scanOutput.addOutput("pixels-test/1.out");
        scanOutput.addOutput("pixels-test/2.out");
        scanOutput.addOutput("pixels-test/3.out");
        Gson gson = new Gson();
