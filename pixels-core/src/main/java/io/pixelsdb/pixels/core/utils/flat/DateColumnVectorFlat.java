...
public final class DateColumnVectorFlat extends Table {
  ...
  public long scratchDate() { int o = __offset(8); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public static int createDateColumnVectorFlat(FlatBufferBuilder builder,
    ...
    DateColumnVectorFlat.addScratchDate(builder, scratchDate);
  ...
  public static void startDateColumnVectorFlat(FlatBufferBuilder builder) { builder.startTable(3); }
  ...
  public static void addScratchDate(FlatBufferBuilder builder, long scratchDate) { builder.addLong(2, scratchDate, 0L); }
