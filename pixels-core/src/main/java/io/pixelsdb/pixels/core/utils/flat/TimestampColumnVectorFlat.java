...
public final class TimestampColumnVectorFlat extends Table {
  ...
  public long scratchTimestamp() { int o = __offset(10); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }

  public static int createTimestampColumnVectorFlat(FlatBufferBuilder builder,
      int baseOffset,
      int precision,
      int timesOffset,
      long scratchTimestamp) {
    builder.startTable(4);
    TimestampColumnVectorFlat.addScratchTimestamp(builder, scratchTimestamp);
  ...
  public static void startTimestampColumnVectorFlat(FlatBufferBuilder builder) { builder.startTable(4); }
  ...
  public static void addScratchTimestamp(FlatBufferBuilder builder, long scratchTimestamp) { builder.addLong(3, scratchTimestamp, 0L); }
