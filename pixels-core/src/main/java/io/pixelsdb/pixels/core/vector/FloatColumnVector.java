...
public class FloatColumnVector extends ColumnVector
{
    ...
    {
        return ColumnVectorFlat.FloatColumnVectorFlat;
    }
    ...
    public int serialize(FlatBufferBuilder builder)
    {
        ...
        int vectorVectorOffset = FloatColumnVectorFlat.createVectorVector(builder, vector);
        FloatColumnVectorFlat.startFloatColumnVectorFlat(builder);
        FloatColumnVectorFlat.addBase(builder, baseOffset);
        FloatColumnVectorFlat.addVector(builder, vectorVectorOffset);
